    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Intento de ingreso invalido.");
                    return View(model);
            }
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //esta linea me permite registrar u usuario y autologearme luego del registro
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ModelState.AddModelError("", "Email invalido, no existe cuenta asociada");
                ...
                await UserManager.SendEmailAsync(user.Id, "Reset Password", "Porfavor reestablece tu contraseña ingresando en el siguiente link <a href=\"" + callbackUrl + "\">Reestablecer Contraseña</a>");
